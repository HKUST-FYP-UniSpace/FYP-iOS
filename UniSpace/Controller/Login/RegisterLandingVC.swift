...
class RegisterLandingVC: MasterLoginVC {
    ...
    lazy private var tenant = RegisterChoiceButton(buttonText: UserType.Tenant.text, buttonImage: UIImage(named: "Student_tenant"))
    lazy private var owner = RegisterChoiceButton(buttonText: UserType.Owner.text, buttonImage: UIImage(named: "House_owner"))
